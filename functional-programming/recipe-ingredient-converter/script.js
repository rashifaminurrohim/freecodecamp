...
//       const convertedQuantity = processIngredient(ingredientQuantity.value, unitToConvert.value, unit, numberOfServings.value);
//       const li = document.createElement('li');
//       const text = `${ingredientName.value}: ${convertedQuantity} ${unit}`;
//       li.innerHTML = text
